...
//    private Map<String, SocketChannel> sockTable = new HashMap<String, SocketChannel>();
    ...
    private BidiMap<String, SocketChannel> sockTable2 = new DualHashBidiMap<String, SocketChannel>();
                        ...
                        if (selected.isReadable()) {
                            ...
                            if (buff.position() != 0) {
                                ...
                                if (behavior.equals("init")) {
                                    ...
                                    sockTable2.put(id, socketChannel);
                                    ...
                                    SocketChannel sock = sockTable2.get(toId);
...
//                                    sockTable.va
                                    sockTable2.inverseBidiMap().remove(socketChannel);
                                    socketChannel.finishConnect();
                                    socketChannel.close();
                                }
                            }
                        ...
                        //비정상 종료
                        //ioe.printStackTrace();
                        System.out.println("remove this client");
                        sockTable2.inverseBidiMap().remove(socketChannel);
                        socketChannel.finishConnect();
                        socketChannel.close();
                    }
